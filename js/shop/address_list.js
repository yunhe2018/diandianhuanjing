...
var Address = {
    ...
    GetList: function () {        
        ...
        request.done(function (msg) {
            if (msg.resultCode >= g_const_Success_Code) {
                Address.Load_Result(msg.page.list);
            } else {
    ...
    Load_Result: function (resultlist) {
        ...
        $.each(resultlist, function (i, n) {
            ...
            htmlStr += "<div onclick=\"Address.Address_S('" + n.code + "')\">";
            ...
            htmlStr += "<b class=\"delete\" onclick=\"Address.Address_D('" + n.code + "')\">删除</b>";
            htmlStr += "<b class=\"edit\" onclick=\"Address.Address_E('" + n.code + "')\">编辑</b>";
            htmlStr += "</div>";
            htmlStr += "</div>";
        });
    ...
    Address_D: function (addressCode) {
        Address.api_inputD.addressID = addressCode;
