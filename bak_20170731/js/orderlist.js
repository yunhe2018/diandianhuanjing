...
var Order = {
    ...
    Load_Result: function (resultlist) {
        ...
        $.each(resultlist, function (i, n) {
            ...
            htmlStr += "</div></div>";
            htmlStr += Order.GetDiv(n.status, n.code, n.payCode, n.path, n.title);
    ...
    GetDiv: function (orderStatus, ordercode, payCode, path, title) {
        ...
        switch (orderStatus) {
            case 0:
                ...
                break;
            case 1:
                statusName = "<span class=\"pay\"><i onclick=\"Order.Share('" + title + "','" + path + "')\">分享</i> <i onclick=\"Order.UpdateStatus(2,'" + ordercode + "','" + path + "')\">下载</i></span>";
                break;
            case 2:
                statusName = "<span class=\"pay\"><i onclick=\"Order.Share('" + title + "','" + path + "')\">分享</i> <i onclick=\"Order.UpdateStatus(2,'" + ordercode + "','" + path + "')\">查看</i></span>";
                break;
            default:
