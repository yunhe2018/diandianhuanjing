    ...
    GetList: function (cityid) {
        ...
        request.done(function (msg) {
            ...
            if (msg.resultCode == g_const_Success_Code) {
                ...
                try {
                    var htmlStr = "";
                    htmlStr += "<dt><span class=\"cel-12\">交易所</span><span class=\"cel-23\">交易日期</span><span class=\"cel-20\">收盘价/元</span><span class=\"cel-22\">交易额/元</span><span class=\"cel-22\">交易量/吨</span></dt>";
                    $.each(msg.repList, function (i, n) {
                        htmlStr += "<dd onclick=\"api_Request.ToBuy('" + n.cityId + "')\"><span class=\"cel-12\">" + n.cityName + "</span><span class=\"cel-23\">" + n.dealDate + "</span><span class=\"cel-20\">" + n.closePrice + "</span><span class=\"cel-22\">" + n.dealAmount + "</span><span class=\"cel-22\">" + n.dealPrice + "</span></dd>";
                    });
